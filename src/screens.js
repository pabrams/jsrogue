...
Game.Screen.helpScreen = {
    render: function(display) {
        ...
        y += 3;
        display.drawText(5, y++, '[g] to pick up items');
        display.drawText(5, y++, '[d] to drop items');
        display.drawText(5, y++, '[e] to eat items');
        display.drawText(5, y++, '[w] to wield items');
        display.drawText(5, y++, '[W] to wear items');
        display.drawText(5, y++, '[x] to examine items');
        display.drawText(5, y++, '[c] to view your character information');
        display.drawText(5, y++, '[;] to look around you');
        display.drawText(5, y++, '[.] to wait (numpad5 also works)');
        y++;
        display.drawText(5, y++, 'Numeric keybad or arrow keys to move');
        display.drawText(5, y++, 'Use Ctrl and Shift with left and right to move diagonally');
        y++;
        display.drawText(5, y++, '[?] to show this help screen');
        y += 3;
